...
namespace LibraryBooks {
    ...
    public partial class BookDataSet : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public BookRow AddBookRow(string BookName, string Author, decimal Price) {
...
namespace LibraryBooks.BookDataSetTableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Book] WHERE (([BookId] = @Original_BookId) AND ([BookName] = @" +
                "Original_BookName) AND ([Author] = @Original_Author) AND ([Price] = @Original_Pr" +
                "ice))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Book] ([BookName], [Author], [Price]) VALUES (@BookName, @Auth" +
                "or, @Price);\r\nSELECT BookId, BookName, Author, Price FROM Book WHERE (BookId = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Book] SET [BookName] = @BookName, [Author] = @Author, [Price] = @Price WHERE (([BookId] = @Original_BookId) AND ([BookName] = @Original_BookName) AND ([Author] = @Original_Author) AND ([Price] = @Original_Price));
SELECT BookId, BookName, Author, Price FROM Book WHERE (BookId = @BookId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LibraryBooks.Properties.Settings.Default.BookDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookId, BookName, Author, Price FROM dbo.Book";
        ...
        public virtual int Delete(int Original_BookId, string Original_BookName, string Original_Author, decimal Original_Price) {
        ...
        public virtual int Insert(string BookName, string Author, decimal Price) {
            if ((BookName == null)) {
        ...
        public virtual int Update(string BookName, string Author, decimal Price, int Original_BookId, string Original_BookName, string Original_Author, decimal Original_Price, int BookId) {
            if ((BookName == null)) {
                throw new global::System.ArgumentNullException("BookName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string BookName, string Author, decimal Price, int Original_BookId, string Original_BookName, string Original_Author, decimal Original_Price) {
            return this.Update(BookName, Author, Price, Original_BookId, Original_BookName, Original_Author, Original_Price, Original_BookId);
        }
    }
